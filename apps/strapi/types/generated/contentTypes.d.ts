...
export interface ApiCommandeCommande extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    commentaires: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    creneauRetrait: Schema.Attribute.JSON & Schema.Attribute.Required;
    dateCreation: Schema.Attribute.DateTime &
      Schema.Attribute.DefaultTo<'now()'>;
    dateMiseAJour: Schema.Attribute.DateTime;
    dateRetiree: Schema.Attribute.DateTime;
    informationsClient: Schema.Attribute.JSON & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    modeRetrait: Schema.Attribute.Enumeration<['RETRAIT']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'RETRAIT'>;
    numero: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    paiementMethode: Schema.Attribute.Enumeration<
      ['CARTE', 'ESPECES', 'CHEQUE', 'VIREMENT']
    >;
    paiementReference: Schema.Attribute.String;
    paiementStatut: Schema.Attribute.Enumeration<
      ['EN_ATTENTE', 'PAYE', 'REMBOURSE', 'ECHOUE']
    > &
      Schema.Attribute.DefaultTo<'EN_ATTENTE'>;
    prixTotal: Schema.Attribute.Decimal & Schema.Attribute.Required;
    produits: Schema.Attribute.JSON & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProduitProduit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    allergenes: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    regimesCompatibles: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    stock: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    tempsPreparation: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<30>;
    unite: Schema.Attribute.Enumeration<
      ['piece', 'gramme', 'kilogramme', 'litre']
    > &
...
export interface ApiUtilisateurUtilisateur extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    adressesSauvegardees: Schema.Attribute.JSON &
      Schema.Attribute.DefaultTo<[]>;
    ...
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    languePreferee: Schema.Attribute.String & Schema.Attribute.DefaultTo<'fr'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::utilisateur.utilisateur'
    > &
      Schema.Attribute.Private;
    nom: Schema.Attribute.String & Schema.Attribute.Required;
    preferencesNotification: Schema.Attribute.JSON &
      Schema.Attribute.DefaultTo<{
        commande: true;
        email: true;
        nouveautes: false;
    ...
    publishedAt: Schema.Attribute.DateTime;
    regimeAlimentaire: Schema.Attribute.Enumeration<
      ['OMNIVORE', 'VEGETARIEN', 'VEGAN', 'SANS_GLUTEN', 'HALAL', 'CASHER']
    >;
    role: Schema.Attribute.Enumeration<['CLIENT', 'EMPLOYE', 'ADMIN']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'CLIENT'>;
    statut: Schema.Attribute.Enumeration<['ACTIF', 'INACTIF', 'SUSPENDU']> &
      Schema.Attribute.Required &
